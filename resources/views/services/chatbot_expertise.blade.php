        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="text-center">
                    ...
                    <p class="title-desc text-muted mt-3">Here goes the small description about "Chat bot"</p>
                </div>
            </div>
        </div>
                ...
                <a href="">
                    <div class="features mt-4">
                        <div class="text-center">
                            ...
                            <h4>Personal or virtual assistant</h4>
